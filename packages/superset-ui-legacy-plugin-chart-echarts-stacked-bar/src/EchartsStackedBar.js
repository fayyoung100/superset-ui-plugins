...
function EchartsStackedBar(element, props) {
  ...
  console.log('echarts-stacked-bar colors======', colors);
...
EchartsStackedBar.displayName = 'EchartsStackedBar';
EchartsStackedBar.propTypes = propTypes;
